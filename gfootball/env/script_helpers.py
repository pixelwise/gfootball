...
class ScriptHelpers(object):
  ...
  def dump_to_video(self, dump_file):
    ...
    # Pixel frames are not stored in dumps. Segmentation can only be
    # regenerated by replaying through the game engine.
    cfg['write_segmentation_video'] = False
    cfg['write_instance_segmentation_video'] = False
